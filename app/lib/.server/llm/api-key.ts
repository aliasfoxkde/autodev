...
export function getAPIKey(cloudflareEnv: Env, provider: string, userApiKeys?: Record<string, string>) {
  ...
  switch (provider) {
    case 'Anthropic':
      return env.ANTHROPIC_API_KEY || cloudflareEnv.ANTHROPIC_API_KEY || process.env.ANTHROPIC_API_KEY;
    case 'OpenAI':
    ...
    case 'HuggingFace':
      return env.HuggingFace_API_KEY || cloudflareEnv.HuggingFace_API_KEY || process.env.HuggingFace_API_KEY;
    case 'OpenRouter':
